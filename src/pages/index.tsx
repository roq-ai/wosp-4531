  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="WOSP - Empowering Fundraisers for Children, One Can at a Time. Secure, Reliable, and Simple to Use. Your Trusted Partner in Money Management for Charitable Causes."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1622186477895-f2af6a0f5a97?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmdW5kcmFpc2VyfGVufDB8fHx8MTY5NjkyOTk2OXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`WOSP - Empowering Fundraisers for Children, One Can at a Time. Secure, Reliable, and Simple to Use. Your Trusted Partner in Money Management for Charitable Causes.`}
            </Text>
            <Box
